resource "aws_instance" "ec2_content_delivery" {
  ami                         = "${var.windows_ami}"
  instance_type               = "${var.ec2_type_content_delivery}"
  ...
  tags  {
    Name                    = "${var.ec2_name_content_delivery}"
    NAME                    = "${var.host_content_delivery}"
