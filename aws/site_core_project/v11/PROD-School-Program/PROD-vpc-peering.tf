...
resource "aws_vpc_peering_connection" "SCP-P1-IRL-T1-VPC-IRL" {
...
resource "aws_vpc_peering_connection_accepter" "T1-VPC-IRL-SCP-P1-IRL" {
  provider                      = "aws.test_vpc"
  vpc_peering_connection_id     = "${aws_vpc_peering_connection.SCP-P1-IRL-T1-VPC-IRL.id}"
  auto_accept                   = true

  tags = {
    Name              = "T1-VPC-IRL-SCP-P1-IRL"
    NAME              = "T1-VPC-IRL-SCP-P1-IRL"
    VPC               = "ACCEPTER"
    ENVIRONMENT       = "PRD"
    REGION            = "EU-WEST-1"
...
resource "aws_vpc_peering_connection" "SCP-P1-IRL-M1-VPC-IRL" {
...
resource "aws_vpc_peering_connection_accepter" "M1-VPC-IRL-SCP-P1-IRL" {
  provider                      = "aws.mgmt_vpc"
  vpc_peering_connection_id     = "${aws_vpc_peering_connection.SCP-P1-IRL-M1-VPC-IRL.id}"
  auto_accept                   = true

  tags = {
    Name              = "M1-VPC-IRL-SCP-P1-IRL"
    NAME              = "M1-VPC-IRL-SCP-P1-IRL"
    VPC               = "ACCEPTER"
    ENVIRONMENT       = "PRD"
    REGION            = "EU-WEST-1"
